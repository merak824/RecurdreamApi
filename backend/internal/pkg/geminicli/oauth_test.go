...
const testGeminiCLIOAuthClientID = "test-gemini-cli-client-id.apps.example.test"

func setTestGeminiCLIClient(t *testing.T, secret string) {
	t.Helper()
	t.Setenv(GeminiCLIOAuthClientIDEnv, testGeminiCLIOAuthClientID)
	t.Setenv(GeminiCLIOAuthClientSecretEnv, secret)
}
...
func TestBuildAuthorizationURL(t *testing.T) {
	setTestGeminiCLIClient(t, "test-secret")
	...
	checks := []string{
		"response_type=code",
		"client_id=" + testGeminiCLIOAuthClientID,
		"redirect_uri=",
		"state=test-state",
...
func TestBuildAuthorizationURL_MissingEnvClient(t *testing.T) {
	...
	if err == nil {
		t.Fatal("BuildAuthorizationURL() missing env client should return error")
	}
}
...
func TestEffectiveOAuthConfig_GoogleOne(t *testing.T) {
	...
	setTestGeminiCLIClient(t, "test-built-in-secret")
...
func TestEffectiveOAuthConfig_MissingEnvClient(t *testing.T) {
	t.Setenv(GeminiCLIOAuthClientIDEnv, "")
	t.Setenv(GeminiCLIOAuthClientSecretEnv, "")

	_, err := EffectiveOAuthConfig(OAuthConfig{}, "code_assist")
	if err == nil {
		t.Fatal("EffectiveOAuthConfig() missing env client should return error")
	}
}
