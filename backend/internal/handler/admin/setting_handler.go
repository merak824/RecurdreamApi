...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAITTFTOptimizerEnabled:                             settings.OpenAITTFTOptimizerEnabled,
		OpenAITTFTBaseP90Seconds:                               settings.OpenAITTFTBaseP90Seconds,
		OpenAITTFTCacheProtectionEnabled:                       settings.OpenAITTFTCacheProtectionEnabled,
		OpenAITTFTCacheMinContextTokens:                        settings.OpenAITTFTCacheMinContextTokens,
		OpenAITTFTCacheMinHitRatePercent:                       settings.OpenAITTFTCacheMinHitRatePercent,
		OpenAITTFTCacheElasticP90CapSeconds:                    settings.OpenAITTFTCacheElasticP90CapSeconds,
