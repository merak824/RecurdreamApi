    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          description: 'Users earn rebate quota when their invitees complete paid orders.',
          ...
          rebateRateHint: 'Default for regular users. Exclusive users always use their own rate (0-100%).',
          customUsers: {
            title: 'Exclusive User Settings',
            description: 'Set an independent rebate rate, optional invite code, and withdrawal access.',
            addButton: 'Add Exclusive User',
            searchPlaceholder: 'Search by email or username',
            empty: 'No exclusive users configured yet',
            customBadge: 'custom',
            resetTitle: 'Remove Exclusive Settings',
            resetMessage: 'Remove exclusive settings for {email}?\n• The user will return to the global rebate rate\n• Withdrawal access will be disabled\n• The invite code will be regenerated (old links will stop working)',
          ...
          modal: {
            ...
            rateLabel: 'Exclusive Rebate Rate',
            ratePlaceholder: 'e.g. 30',
            rateHint: 'Required, from 0 to 100. This never falls back to the global rate.',
            withdrawalLabel: 'Allow WeChat or Alipay withdrawal',
            withdrawalHint: 'When off, rebate quota can still be transferred to account balance.',
            errorBadRate: 'Please enter a number between 0 and 100',
            errorEmpty: 'Select a user and enter a valid exclusive rebate rate',
          },
        },
      },
