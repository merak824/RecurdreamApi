export default {
    ...
    dashboard: {
      ...
      profitMonitor: 'Usage Margin (not cash profit)',
      profitMonitorHint: 'Official accounts use zero upstream cost. Relay accounts use observed charges or group-rate estimates and can be reconciled automatically.',
      profitSales: 'Sales',
      profitCost: 'Recorded cost',
      profit: 'Gross profit',
      profitMargin: 'Gross margin',
      profitTrend: 'Margin trend',
      profitGroups: 'Groups',
      profitModels: 'Models',
      profitAccounts: 'Upstream accounts',
      profitDimension: 'Dimension',
      profitRequests: 'Requests',
      profitTokens: 'Tokens',
      profitSource: 'Cost source',
      profitStatus: 'Verification',
      profitUnverified: 'Unverified',
      profitReconciliationStatus: 'Reconciliation',
      profitReconciliationMatched: 'Reconciled',
      profitReconciliationDifference: 'Difference',
      profitReconciliationPending: 'Waiting for next sample',
      profitReconciliationMissingStart: 'Start sample unavailable',
      profitReconciliationSampleUnauthorized: 'Sampling failed: upstream authorization rejected',
      profitReconciliationSampleFailed: 'Sampling failed: upstream connection error',
      profitReconciliationSampleUnsupported: 'Upstream billing sampling unsupported',
      profitReconciliationUnavailable: 'Unavailable',
      profitReconciliationEstimated: 'Manual estimate',
      profitReconciliationOfficialZero: 'Official cost is zero',
      profitLastSample: 'Last sample',
      profitNextSample: 'Estimated next sample',
      profitUpstreamActualCost: 'Upstream actual',
      profitReconciliationDifferenceAmount: 'Difference',
      profitPendingCostCount: 'Pending cost',
      profitNoData: 'No margin data for this range',
      profitLocalEstimate: 'Usage-record estimate',
      profitUpstreamProbe: 'Upstream probe',
      profitGroupEstimate: 'Manual estimate (group-rate break-even)',
      profitOfficialUpstream: 'Official account (zero cost)',
      profitCostUnknown: 'Pending confirmation',
      profitMixed: 'Upstream probe + manual estimate',
      profitLegacyFormula: 'Historical formula',
      profitNegative: 'Loss'
    },
    ...
    users: {
      ...
      balanceHistoryTip: 'Click to open balance history',
