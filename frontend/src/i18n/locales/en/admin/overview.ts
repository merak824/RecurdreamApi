export default {
    ...
    dashboard: {
      ...
      profitMonitorHint: 'Sales are user charges. Upstream cost is calculated per usage record as its cost basis times the upstream rate recorded for that request; it is not reconciled with an upstream bill yet.',
      profitSales: 'Sales',
      profitCost: 'Upstream cost',
      profit: 'Gross profit',
