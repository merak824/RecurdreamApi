export default {
  ...
  usage: {
    ...
    latencyUpstreamFirstToken: 'Upstream first',
    latencyDuration: 'Total',
    ttftDiagnostics: 'First-token scheduling diagnostics',
    ttftOptimizerApplied: 'First-token optimization',
    ttftTransport: 'Transport',
    ttftSamples: 'Historical samples',
    ttftCacheProfile: 'Cache profile',
    ttftCacheEligible: 'Cache protection',
    ttftCacheContext: 'Context tokens',
    ttftCacheHitRate: 'Cache hit rate',
    ttftP90Thresholds: 'P90 thresholds',
    ttftDecision: 'Decision',
    ttftReason: 'Reason',
    ttftFirstSemanticEvent: 'First semantic event',
    ttftYes: 'eligible',
    ttftNo: 'not eligible',
    ttftApplied: 'applied',
    ttftNotApplied: 'not applied to this request',
    ttftDecisionSwitched: 'switched account',
    ttftDecisionDebounced: 'kept by debounce',
    ttftDecisionKept: 'kept current account',
    ttftCacheStatusEligible: 'valid',
    ttftCacheStatusDisabled: 'cache protection disabled',
    ttftCacheStatusMissing: 'missing',
    ttftCacheStatusExpired: 'expired',
    ttftCacheStatusInvalid: 'invalid',
    ttftCacheStatusShortContext: 'context below threshold',
    ttftCacheStatusLowHitRate: 'hit rate below threshold',
    ttftCacheStatusReadError: 'read failed',
    ttftCacheStatusUnavailable: 'unavailable',
    ttftReasonP90: 'historical P90 exceeded threshold',
    ttftReasonConcurrencyFull: 'original account concurrency full',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
    sync: 'Sync',
