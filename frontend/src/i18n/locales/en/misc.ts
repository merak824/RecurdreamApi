export default {
  ...
  payment: {
    ...
    orders: {
      title: 'My Orders',
      orderTab: 'Top-up Orders',
      balanceHistoryTab: 'Balance History',
      balanceHistoryTitle: 'Balance Activity',
      balanceHistorySubtitle: 'Top-ups, affiliate transfers, red packet rewards, and admin adjustments',
      balanceHistoryLoadFailed: 'Failed to load balance history',
      noBalanceHistory: 'No balance activity yet',
      redPacketPeriod: 'Period {period}',
      balanceTypes: {
        all: 'All Types',
        recharge: 'Balance Top-up',
        admin: 'Admin Adjustment',
        adminCredit: 'Admin Credit',
        adminDebit: 'Admin Deduction',
        affiliate: 'Affiliate Transfer',
        redPacket: 'Red Packet Reward',
      },
      empty: 'No orders yet',
      orderId: 'Order ID',
      orderNo: 'Order No.',
