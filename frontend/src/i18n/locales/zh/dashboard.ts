export default {
  ...
  usage: {
    ...
    latencyDuration: '总耗时',
    ttftDiagnostics: '首 Token 调度诊断',
    ttftOptimizerApplied: '首 Token 优化',
    ttftTransport: '上游传输',
    ttftSamples: '历史样本',
    ttftCacheProfile: '缓存画像',
    ttftCacheEligible: '缓存保护',
    ttftCacheContext: '上下文 Token',
    ttftCacheHitRate: '缓存命中率',
    ttftP90Thresholds: 'P90 门槛',
    ttftDecision: '调度决策',
    ttftReason: '原因',
    ttftFirstSemanticEvent: '首个语义事件',
    ttftYes: '符合条件',
    ttftNo: '不符合条件',
    ttftApplied: '已应用',
    ttftNotApplied: '本次未应用',
    ttftDecisionSwitched: '已切换账号',
    ttftDecisionDebounced: '防抖保持原账号',
    ttftDecisionKept: '保持当前账号',
    ttftCacheStatusEligible: '有效',
    ttftCacheStatusDisabled: '缓存保护已关闭',
    ttftCacheStatusMissing: '缺失',
    ttftCacheStatusExpired: '已过期',
    ttftCacheStatusInvalid: '无效',
    ttftCacheStatusShortContext: '上下文未达门槛',
    ttftCacheStatusLowHitRate: '命中率未达门槛',
    ttftCacheStatusReadError: '读取失败',
    ttftCacheStatusUnavailable: '不可用',
    ttftReasonP90: '历史 P90 超过门槛',
    ttftReasonConcurrencyFull: '原账号并发已满',
    time: '时间',
    ws: 'WS',
    stream: '流式',
    sync: '同步',
