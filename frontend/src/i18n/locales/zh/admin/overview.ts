export default {
    ...
    dashboard: {
      ...
      profitMonitor: '用量毛利（非现金利润）',
      profitMonitorHint: '官方账号按上游成本 0 计入；中转账号按探测实扣或分组倍率估算，并可自动对账。',
      profitSales: '销售额',
      profitCost: '记录成本',
      profit: '毛利润',
      profitMargin: '毛利率',
      ...
      profitSource: '成本来源',
      profitStatus: '核验状态',
      profitUnverified: '未核验',
      profitReconciliationStatus: '对账状态',
      profitReconciliationMatched: '已对账',
      profitReconciliationDifference: '有差异',
      profitReconciliationPending: '等待下一次采样',
      profitReconciliationMissingStart: '缺少起始采样',
      profitReconciliationSampleUnauthorized: '采样失败：上游拒绝授权',
      profitReconciliationSampleFailed: '采样失败：连接上游失败',
      profitReconciliationSampleUnsupported: '上游不支持账单采样',
      profitReconciliationUnavailable: '暂不可对账',
      profitReconciliationEstimated: '人工估算',
      profitReconciliationOfficialZero: '官方成本为 0',
      profitLastSample: '最近采样',
      profitNextSample: '预计下次采样',
      profitUpstreamActualCost: '上游实扣',
      profitReconciliationDifferenceAmount: '差额',
      profitPendingCostCount: '成本待确认',
      profitNoData: '当前范围暂无利润数据',
      profitLocalEstimate: '使用记录估算',
      profitUpstreamProbe: '上游探测',
      profitGroupEstimate: '人工估算（按分组倍率）',
      profitOfficialUpstream: '官方账号（成本 0）',
      profitCostUnknown: '待确认',
      profitMixed: '上游探测 + 人工估算',
      profitLegacyFormula: '历史公式',
      profitNegative: '亏损'
    },
    ...
    users: {
      ...
      platformOther: '其他',
      balanceHistoryTitle: '用户余额变动明细',
      noBalanceHistory: '暂无变动记录',
      allTypes: '全部类型',
      typeBalance: '余额（兑换码）',
      typeAffiliateBalance: '余额（返利转入）',
      typeRedPacketReward: '红包奖励',
