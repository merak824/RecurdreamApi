export default {
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: '邀请返利',
          description: '用户邀请新用户注册，新用户完成付费订单后邀请人按比例获得返利额度。',
          enabled: '启用邀请返利',
          enabledHint: '关闭后用户菜单中的邀请页面入口隐藏、注册时忽略邀请码、新充值不再产生返利。已有返利额度仍可转入余额。',
          rebateRate: '全局返利比例',
          rebateRateHint: '普通用户默认使用该比例；专属用户使用各自的独立比例（0-100%）。',
          customUsers: {
            title: '专属用户配置',
            description: '为指定用户设置独立返利比例、可选邀请码和提现权限。',
            addButton: '添加专属用户',
            searchPlaceholder: '搜索邮箱或用户名',
            empty: '暂无专属配置用户',
            customBadge: '自定义',
            resetTitle: '重置该用户的专属配置',
            resetMessage: '确认删除 {email} 的专属配置？\n• 该用户将恢复使用全局返利比例\n• 提现权限将关闭\n• 邀请码将重新生成为系统随机码（旧邀请链接将失效）',
          ...
          modal: {
            ...
            rateHint: '必填，范围 0-100%，不会沿用全局比例。',
            withdrawalLabel: '允许提现到微信或支付宝',
            withdrawalHint: '未开启时仍可将返利转入站内余额。',
            errorBadRate: '请输入 0-100 之间的比例',
            errorEmpty: '请选择用户并填写有效的专属返利比例',
          },
        },
      },
