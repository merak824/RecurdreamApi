...
import zhAdminCompliance from '@/content/legal/admin-compliance.zh.md?raw'
import enAdminCompliance from '@/content/legal/admin-compliance.en.md?raw'
...
const siteLogo = computed(() => sanitizeUrl(resolveSiteLogo(settings.value?.site_logo), {
  allowRelative: true,
  allowDataUrl: true,
}) || DEFAULT_SITE_LOGO)
